...
static void Error(repetition_tester* Tester, const char* Message)
{
...
static void NewTestWave(repetition_tester* Tester, u64 TargetProcessedByteCount, u64 CPUTimerFreq, u32 SecondsToTry = 10)
{
   ...
   Tester->TesterStartedAt = ReadCPUTimer();
}
...
static b32 IsTesting(repetition_tester* Tester)
{
   if (Tester->Mode == TestMode_Testing)
   {
      ...
      if (Tester->OpenBlockCount)
      {
         ...
         if (Tester->AccumulatedOnThisTest.E[RepValue_ByteCount] != Tester->TargetProcessedByteCount)
         {
         ...
         if (Tester->Mode == TestMode_Testing)
         {
            ...
            if (Results->Min.E[RepValue_CPUTimer] > Accum.E[RepValue_CPUTimer])
            {
               ...
               Tester->TesterStartedAt = CurrentTime;
      ...
      if ((CurrentTime - Tester->TesterStartedAt) > Tester->TryForTime)
      {
